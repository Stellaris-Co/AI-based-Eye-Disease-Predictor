...
MODEL_SAVE_PATH = os.path.join(PROJECT_ROOT, 'models', 'specialist_anterior.pth')
...
def main():
    ...
    print(f"\n🚀 STAGE 2: ANTERIOR SPECIALIST TRAINING ({TARGET_FOLDER})")
    ...
    for epoch in range(EPOCHS):
        model.train()
        running_loss = 0.0
        pbar = tqdm(train_loader, desc=f"Anterior Epoch {epoch+1}/{EPOCHS}")
